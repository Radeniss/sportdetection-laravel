# -*- coding: utf-8 -*-
"""deteksi olahraga.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1rlTt-ggDESRpRmpazatCNFBqNoezoPKC
"""
...
def process_video(in_path, out_path="output.mp4", img_size=640):
    ...
    while True:
        ...
        if len(res.keypoints) > 0:
            ...
            # render pose di frame (pakai built-in plot)
            plotted = res.plot()  # menggambar semua deteksi
            frame = plotted
