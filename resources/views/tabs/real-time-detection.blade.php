<div class="max-w-2xl mx-auto bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-8 border-2 border-green-200">
    ...
    <div class="bg-white rounded-lg p-6">
        ...
        <div x-show="cameraActive" class="space-y-4">
            <div class="bg-slate-900 rounded-lg aspect-video flex items-center justify-center relative overflow-hidden">
                <video x-ref="videoPlayer" autoplay playsinline class="w-full h-full object-cover"></video>
                <img x-show="overlayFrame" :src="overlayFrame" class="absolute inset-0 w-full h-full object-cover" />
            ...
            <div class="grid grid-cols-3 gap-3 text-center">
                <div class="bg-green-100 text-green-800 rounded-lg py-3 font-semibold">Push-up: <span x-text="counts.pushup"></span></div>
                <div class="bg-blue-100 text-blue-800 rounded-lg py-3 font-semibold">Squat: <span x-text="counts.squat"></span></div>
                <div class="bg-orange-100 text-orange-800 rounded-lg py-3 font-semibold">Jumping Jack: <span x-text="counts.jj"></span></div>
            </div>
...
<canvas x-ref="realtimeCanvas" class="hidden"></canvas>
